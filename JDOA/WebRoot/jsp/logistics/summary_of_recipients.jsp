...
<script type="text/javascript">
      ...
      function loadGrid(){
	          ...
	          var coM=[ 	  
                     	  	  {header:'办公用品名称', name : 'fname', align : 'center', width : '265'},
                     		  {header:'领用总数量', name : 'ftotal_quantity',width: 265,align : 'center'},
                     		  {header:'办公用品型号',name:'ftype',width : 265,align : 'center'},
                     		  {header:'备注',name:'fcomment',width: 265,align : 'center'},
            ...
            $('#grid').omGrid({
                ...
                colModel : coM,
                autoFit:true,
				dataSource :"queryAllSummaryOfRecipients",
            ...
            //保存   新增
             ...
             $( "#dialog-modal").omDialog({
                ...
                if(conditions == ""){ //没要有查询条件，要显示全部数据
                    $('#grid').omGrid("setData", 'queryAllSummaryOfRecipients');
                    $('#conditions').val('');
                }else{ //有查询条件，显示查询数据
                    $('#grid').omGrid("setData", 'fuzzyQuerySummaryOfRecipients?conditions='+ conditions );
                    $('#conditions').val('');
                  }
			});
