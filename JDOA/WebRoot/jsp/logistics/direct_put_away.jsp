...
<script type="text/javascript">
      ...
      function loadGrid(){
	          ...
	          var coM=[ 	  
                     	  {header:'入库用品名称', name : 'fincoming_goods_name', width : '170', align : 'center',wrap:true}, 
                     	  {header:'数量', name : 'famount', align : 'center', width : '170'},
                          {header:'备注信息', name : 'fcomment', align : 'center', width : '170'},
                     	  {header:'创建者', name : 'fcreator',width: 170,align : 'center',wrap:true},
                     	  {header:'创建日期', name : 'fcreation_date',width: 170,align : 'center'},
                     	  {header:'品牌/型号',name:'ftype',width : 170,align : 'center'},
                       ];
            ...
            $('#grid').omGrid({
                ...
                colModel : coM,
                autoFit:true,
				dataSource :"queryAllDirectPutAway",
...
<body style="padding: 0px;margin: 0px;">
       ...
       <div>
    	<table id="grid"></table>
         ...
         <div id="dialog-modal" title="新增直接入库">
        	<div style="text-align: center;color: red;"><h1>新增直接入库</h1></div>
