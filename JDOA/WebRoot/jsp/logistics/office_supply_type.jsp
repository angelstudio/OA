...
<script type="text/javascript">
      ...
      function loadGrid(){
	          ...
	          var coM=[ 	  
                     	  {header:'办公用品名称', name : 'fname', width : '170', align : 'center',wrap:true}, 
                     	  {header:'类型', name : 'ftype', align : 'center', width : '180'},
                          {header:'创建部门', name : 'fdepartment', align : 'center', width : '170'},
                     	  {header:'创建者', name : 'fcreator',width: 170,align : 'center',wrap:true},
                     	  {header:'创建日期', name : 'fcreation_date',width: 170,align : 'center'},
                     	  {header:'备注',name:'fcomment',width : 175,align : 'center'},
                       ];
            ...
            $('#grid').omGrid({
                ...
                colModel : coM,
                autoFit:true,
				dataSource :"queryAllOfficeSupplyType",
	  ...
	  function setPersonInfo(){
	  		...
	  		$("#fdepartment").val(personData.frecipientsdepartment).attr("disabled","disabled");
	  		$("#fcreator").val(personData.freceiver).attr("disabled","disabled");
	  		$("#fcreation_date").val(personData.frecipientsdate).attr("disabled","disabled");  
	  }
      //编辑
...
<body style="padding: 0px;margin: 0px;">
       <div id="fcommonquery">
                       办公用品名称(模糊查询，为空时显示全部) <input id="find" />  
       ...
       <div>
    	<table id="grid"></table>
         ...
         <div id="dialog-modal" title="新增办公用品类型">
        	<div style="text-align: center;color: red;"><h1>新增办公用品类型</h1></div>
         ...
         <form  id="dataFrom">
        	<table width="100%" style="text-align: left;margin-bottom: 20px;">
        	    ...
        	    <tr>
        		<td width="10%" >创建人:</td>
        		<td width="35%" ><input type="text" id="fcreator" name="fcreator" /></td>
        		
        		<td width="10%">创建日期:</td>
        		<td width="35%" ><input type="text" id="fcreation_date" name="fcreation_date" /></td>
        		</tr>
        		
        		<tr>
        		<td width="10%" >创建部门:</td>
        		<td width="35%" ><input type="text" id="fdepartment" name="fdepartment" /></td>
        		</tr>
        	    <tr> 
        	    <td width="10%" >备注:</td>
