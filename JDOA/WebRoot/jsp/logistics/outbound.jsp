...
<script type="text/javascript">
      ...
      function loadGrid(){
	          ...
	          var coM=[ 	  
                     	  {header:'出库用品名称', name : 'foutbound_goods_name', width : '130', align : 'center',wrap:true}, 
                     	  {header:'数量', name : 'famount', align : 'center', width : '130'},
                     	  {header:'备注信息', name : 'fcomment', align : 'center', width : '130'},
                       	  {header:'创建者', name : 'fcreator',width: 130,align : 'center',wrap:true},
                     	  {header:'创建时间', name : 'fcreation_date',width: 130,align : 'center'},
                     	  {header:'创建部门',name:'fdepartment',width: 120,align : 'center'},
                     	  {header:'审核人',name:'fauditor',width : 120,align : 'center'},
                     	  {header:'品牌/型号',name:'ftype',width : 120,align : 'center'},
                       ];
      ...
      function editInventory(){
        ...
        $("#edfoutbound_goods_name").val(data.foutbound_goods_name);
        
        $("#editpid").val(data.foutbound_id);
    ...
    function delInventory(){
	  ...
	  var operation ="delete"; 
       ...
       $.ajax({  
		         type: "POST",  
		         url: "addOutbound?fid="+data.foutbound_id+"&operation="+operation, 
		         dataType: "json",  
		         success: function(data){  
		            if(data.success == "success"){ 
		                loadGrid();
...
<body style="padding: 0px;margin: 0px;">
       <div id="fcommonquery">
                       出库用品名称(模糊查询，为空时显示全部) <input id="find" />  
       ...
       <div>
    	<table id="grid"></table>
         ...
         <div id="dialog-modal" title="新增出库">
        	<div style="text-align: center;color: red;"><h1>新增出库</h1></div>
         ...
         <form  id="dataFrom">
        	<table width="100%" style="text-align: left;margin-bottom: 20px;">
        	    ...
        	    <tr>
        	    <td  width="10%" >出库物品名称:</td>
        	    <td  width="35%" ><input type="text"  id="" name="foutbound_goods_name" /></td>
        	    <td  width="10%" >出库数量:</td>
	 ...
	 <div id="editInventory" title="修改办公用品出库">
        	<div style="text-align: center;color: red;"><h1>修改办公用品出库</h1></div>
        	<hr style="height:3px;border:none;border-top:3px double red;"/>
				...
				<form id="editfrom">
					<table width="100%" style="text-align: left;margin-top: 30px;">
						...
						<tr>
							<td  width="10%" >出库物品名称:</td>
        	    			<td  width="35%" ><input type="text"  id="edfoutbound_goods_name" 
        	    				name="foutbound_goods_name" /></td>
							<td width="10%" >修改人:</td>
