...
<html>
	<head>
        ...
        <script type="text/javascript" src="../../js/tool/urlUtil.js"></script>
         <script type="text/javascript" src="../js/jbpm_common.js"></script>
	...
	<body>
	 ...
	 <div>
	   <table>
	      <tr>
	         <td>人员名称:</td>
	         <td><input id="fname" name="fname" class="sText"/></td>
	         <td>身份证号码:</td>
	...
	<script type="text/javascript">
		  ...
		  $(document).ready(function(){
			  ...
			  $("#ftj").click(function(){
			      jbpmSubmit("451ce37a0350420aadfe29886d887d332222_psn","person");
			  });
		     $('#jbpm_toolbar').omButtonbar({});
          });
          //获取json对象
          function getJson(){
             var json={};
