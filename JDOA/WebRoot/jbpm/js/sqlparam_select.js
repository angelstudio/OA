	...
	var grid = new Ext.grid.GridPanel({
		...
		listeners : {
			"rowdblclick" : function(grid, rowIndex, e) {
				window.parent
						.fillBackSqlParamData(grid.getStore().getAt(rowIndex).data);
			}
		},
		buttons : [{
			text : '确认',
			...
			handler : function() {
				...
				if (selectRow != null) {
					window.parent.fillBackSqlParamData(grid.getSelectionModel().getSelected().data);
				} else {
